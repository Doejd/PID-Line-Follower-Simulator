...
class MapLoader:
    ...
    def get_pixel_color(self, x : int, y : int):
        x_ = int(x) - self.margin[0] # convert from global coordinates to local coordinates
        y_ = int(y) - self.margin[1] # convert from global coordinates to local coordinates
    ...
    def draw(self, surface):
        surface.blit(self.map_image, self.margin)